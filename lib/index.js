...
module.exports = function (app) {
    app.on('member_added', function (context) { return __awaiter(_this, void 0, void 0, function () {
        var res, content, yaml, config, response, decoded, split, id, teamParams;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, context.github.repos.getContents({
